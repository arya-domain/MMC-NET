...
from .mamba_attention import Mamba_Attention_layer
...
class Grapher(nn.Module):
    ...
    def __init__(self, in_channels, kernel_size=9, dilation=1, conv='edge', act='relu', norm=None,
                 bias=True,  stochastic=False, epsilon=0.0, r=1, n=196, drop_path=0.0, relative_pos=False, padding=4, mamba=True):
        ...
        self.mamba =mamba
        if mamba:
            self.mamba = Mamba_Attention_layer(d_model=in_channels,
                                    d_state=128,
                                    d_conv=4,
                                    expand=1,
                                    ).cuda()
